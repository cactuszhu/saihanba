...
const DashBoard=()=>import('@/page/dataVisual/dashboard')
const Senlin=()=>import('@/page/dataVisual/senlin')
const Mapbox=()=>import('@/page/dataVisual/mapbox')
  ...
  routes: [
    {
      ...
      children:[
        ...
        {path:'/senlin',name:'senlin',component:Senlin},
