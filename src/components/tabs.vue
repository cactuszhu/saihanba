...
<el-menu default-active="1-1" class="el-menu-vertical-demo" 
  ...
  <el-submenu :index="String(index+1)" v-if="item.childFlag">
    ...
    <el-menu-item-group>
      <el-menu-item :index="itemChild.index" 
      v-for="(itemChild,indexChild) in item.tabChild" 
      :key="indexChild">{{itemChild.content}}
      </el-menu-item>
    </el-menu-item-group>
  </el-submenu>
      ...
      tabArr: [
        {
          ...
          childFlag: true,
          tabChild: [
            { index: "1-1", content: "森林数据", routerData: "Senlin" },
            { index: "1-2", content: "林产品数据", routerData: "speEcharts" },
            { index: "1-3", content: "地图", routerData: "map" },
            { index: "1-4", content: "旅游数据", routerData: "dashboard" },
            //{ index: "1-5", content: "3D地图数据", routerData: "mapbox" },
          ]
        },
        {
          name: "表格",
          ...
          childFlag: true,
          tabChild: [
            { index: "2-1", content: "森林资源消长表", routerData: "comTable" },
            { index: "2-2", content: "旅游数据表", routerData: "comTable" },
            { index: "2-3", content: "林产品数据表", routerData: "comTable" },
