  ...
  <div class="home">
    ...
    <div class="top">
      <div :class="['top-left',{'top-left-shrink':!shrinkFlag}]">
        <!-- <img  class="top-img" src="../assets/icon.png" alt=""> -->
        <!-- <span class="top-name" v-if="shrinkFlag"></span> -->
      </div>
      ...
      <span class="top-crumbs">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item v-for="(item,index) in crumbData" 
      ...
      <div class="top-right">
        ...
        <!-- <el-dropdown :hide-on-click="false">
          <span class="el-dropdown-link">
              <img  class="login-img" src="../assets/icon.png" alt=""><span class="login-text">用户</span>
      ...
      <div class="title">塞罕坝林场森林生态环境数据可视化系统</div>
    </div>
...
export default {
  ...
  data() {
    return {
      tags: [{ name: "森林数据", routerData: "comEcharts", type: "info" }],
      shrinkFlag: true,
      crumbData: ["数据可视化", "森林数据"],
      n: 0
    };
  },
